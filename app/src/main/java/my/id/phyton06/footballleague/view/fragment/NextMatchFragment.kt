...
class NextMatchFragment : RxBaseFragment() {
        ...
        subscriptions.add(provideService()
            ...
            .subscribe({
                ...
                if(error.cause.toString() == "null"){
                    ...
                    builder.setMessage("NEXT MATCH : "+error.localizedMessage)
                        .setPositiveButton(
                            "OK"
                        ) { dialog, which ->
                            when (which) {
